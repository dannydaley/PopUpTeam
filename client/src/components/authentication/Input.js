...
export default function Input(props) {
  ...
  const [isFocused, setIsFocused] = useState(false); // For input icon focus outline
  ...
  return type === "password" ? (
    <div className="mb-8">
      ...
      <div className="w-full flex items-center">
        <input
          ...
          } w-full px-3 py-2.5 text-sm leading-tight border focus:border-blue-500 rounded-md rounded-r-none focus:outline-none`}
        />
        ...
        {passwordShow ? (
          <div
            ...
            className="p-3 border border-l-0 rounded-r-md bg-gray-100"
          >
    ...
    <div className="mb-4">
      <label className="container block mb-2 text-sm font-medium text-gray-700">
        {label}
      </label>
      ...
      <input
        ...
        className={`${
          error ? "border-red-500 rounded" : "border-gray-200"
        } w-full px-3 py-2.5 mb-3 text-sm leading-tight border focus:border-blue-500 rounded-md focus:outline-none`}
      />
    </div>
  );
};