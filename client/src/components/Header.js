...
function MobileNavigation() {
  ...
  useEffect(() => {
    ...
    axios.get("http://localhost:8080/auth/signin")
      .then((res) => {
        //If user is logged in, set state to true else leave false
        ...
        >
          ...
          >
            ...
            {isLoggedIn ? (
              ...
              <MobileNavLink href="/business-login">
                Sign in
              </MobileNavLink>
            )}
          </Popover.Panel>
              ...
              {isLoggedIn ? (
                <Link to="/directory">
                  ...
                  <svg
                    ...
                    stroke-width="1.5"
                    stroke="currentColor"
                    class="w-6 h-6 hover:stroke-blue-500 hover:cursor-pointer"
                  >
                    <path
                      stroke-linecap="round"
                      stroke-linejoin="round"
