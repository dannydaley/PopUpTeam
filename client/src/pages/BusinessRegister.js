      ...
      <AuthLayout>
        ...
        >
          ...
          {error === 'Username already exists' && 
            <p class="col-span-full -mt-4 mb-4 text-xs italic text-red-500">Username already exists</p>
          }
          ...
          {error === 'Names may only contain alphabetic characters' && 
            <p class="-mt-4 mb-4 text-xs italic text-red-500">Names may only contain alphabetic characters</p>
          }
          ...
          {error === 'Email already exists' && 
            <p class="-mt-4 mb-4 text-xs italic text-red-500">Email already exists</p>
          }
          ...
          <Input
            ...
            handleChange={handleChange}
            error={error === "Password must contain at least one uppercase letter" || error === "Password must contain at least one number" || error === "Password must be at least 8 characters long" ? error : "" || error === "Passwords do not match" ? error : ""}
          />
          ...
          {error === 'Password must contain at least one uppercase letter' &&
            <p class="col-span-full -mt-4 mb-4 text-xs italic text-red-500">Password must contain at least one uppercase letter</p>
          }

          {error === 'Password must contain at least one number' &&
            <p class="col-span-full -mt-4 mb-4 text-xs italic text-red-500">Password must contain at least one number</p>
          }

          {error === 'Password must be at least 8 characters long' &&
            <p class="col-span-full -mt-4 mb-4 text-xs italic text-red-500">Password must be at least 8 characters long</p>
          }

          {error === 'Passwords do not match' && 
            <p class="col-span-full -mt-4 mb-4 text-xs italic text-red-500">Passwords do not match</p>
          }   
